...
class FileSyncStub(object):
    ...
    def __init__(self, channel):
        ...
        self.update_file_name = channel.unary_unary(
            '/FileSync/update_file_name',
        ...
        self.get_file_metadata = channel.unary_unary(
            '/FileSync/get_file_metadata',
            request_serializer=file__sync__pb2.FileRequest.SerializeToString,
            response_deserializer=file__sync__pb2.FileMetadata.FromString,
        )
...
def add_FileSyncServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        'update_file_name': grpc.unary_unary_rpc_method_handler(
        ...
        'get_file_metadata': grpc.unary_unary_rpc_method_handler(
            servicer.get_file_metadata,
            request_deserializer=file__sync__pb2.FileRequest.FromString,
            response_serializer=file__sync__pb2.FileMetadata.SerializeToString,
        ),
    }
...
class FileSync(object):
    ...
    def get_file_metadata(request,
                          ...
                          timeout=None,
                          metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FileSync/get_file_metadata',
                                             file__sync__pb2.FileRequest.SerializeToString,
                                             file__sync__pb2.FileMetadata.FromString,
                                             options, channel_credentials,
                                             insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
